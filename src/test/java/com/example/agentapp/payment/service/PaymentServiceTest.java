...
import com.example.agentapp.payment.dto.PaymentCreateRequest;
import com.example.agentapp.payment.dto.RefundCreateRequest;
...
class PaymentServiceTest {
    ...
    void setUp() {
        ...
        when(activeReservation.getUser()).thenReturn(mock(com.example.agentapp.auth.model.User.class));
    }
